...
namespace NSE.Carrinho.API.Controllers
{
	...
	public class CarrinhoController : MainController
	{
		...
		private async Task<CarrinhoItem> ObterItemCarrinhoValidado(Guid produtoId, CarrinhoCliente carrinho, CarrinhoItem item = null)
		{
			...
			var itemCarrinho = await _context.CarrinhoItens.FirstOrDefaultAsync(i => 
				i.CarrinhoId == carrinho.Id && i.ProdutoId == produtoId);
		...
		private bool ValidarCarrinho(CarrinhoCliente carrinho)
		{
			...
			carrinho.ValidationResult.Errors.ToList().ForEach(e =>
				AdicionarErroProcessamento(e.ErrorMessage));
